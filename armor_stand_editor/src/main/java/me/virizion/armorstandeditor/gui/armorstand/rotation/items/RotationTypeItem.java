...
public class RotationTypeItem extends GUIItem<RotationSetGUI>
{
	...
	public RotationTypeItem(RotationSetGUI gui, RotatableType rotatableType)
	{
		super(gui);
	...
	public ItemStack getItemStack()
	{
		...
		ItemStack itemStack = this.rotatableType == RotatableType.HEAD ? this.gui.getRotationSelectGUI().getArmorStandGUI().getArmorStand().getHelmet() : (this.rotatableType == RotatableType.BODY ? this.gui.getRotationSelectGUI().getArmorStandGUI().getArmorStand().getChestplate() : (this.rotatableType == RotatableType.LEFT_ARM ? (this.gui.getArmorStandEditor().isOffHandSupported() ? this.gui.getRotationSelectGUI().getArmorStandGUI().getArmorStand().getEquipment().getItemInOffHand() : new ItemStack(Material.STICK)) : (this.rotatableType == RotatableType.RIGHT_ARM ? this.gui.getRotationSelectGUI().getArmorStandGUI().getArmorStand().getItemInHand() : new ItemStack(Material.STICK))));
